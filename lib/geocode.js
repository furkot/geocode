...
function furkotGeocode(options) {
  const services = {
    geocodio: {
      init: require('./service/geocodio/index.js')
    },
    graphhopper: {
      init: require('./service/graphhopper/index.js')
    },
    hogfish: {
      init: require('./service/hogfish/index.js')
    },
    locationiq: {
      init: require('./service/locationiq/index.js')
    },
    opencage: {
      init: require('./service/opencage/index.js')
    },
    pelias: {
      init: require('./service/pelias/index.js')
    },
    positionstack: {
      init: require('./service/positionstack/index.js')
    },
    synchronous: {
      init: require('./service/synchronous/index.js')
    },
    maptiler: {
      init: require('./service/maptiler/index.js')
    }
  };
